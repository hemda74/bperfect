...
export async function POST(req: NextRequest) {
	try {
		const { firstName, lastName, email, subject } = await req.json();
		...
		const mailOptionsToAdmin = {
			...
			subject: `New Appointement Request from ${firstName} ${lastName}`,
                                        ...
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <h2 style="margin: 0; color: #18223b; direction: ltr; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 25px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;">
                                                    <strong> Hello BPerfect Admin You Have New Appointment Request</strong></h2>
                                            </td>
                                        </tr>
                                    </table>
...
<div style="font-family: inherit; text-align: inherit; font-size: 17px"><br></div><div></div></div></td>
    ...
    <tbody>
      ...
      <a  href="https://www.facebook.com/BPerfectClinic" target="_blank" alt="Facebook" title="Facebook" style="display:inline-block; background-color:#fff; height:48px; width:48px; border-radius:2px; -webkit-border-radius:2px; -moz-border-radius:2px;">
	...
	<td style="padding: 0px 5px;" class="social-icon-column">
      <a  href="https://www.instagram.com/bperfect.clinic/" target="_blank" alt="Instagram" title="Instagram" style="display:inline-block; background-color:#fff; height:48px; width:48px; border-radius:2px; -webkit-border-radius:2px; -moz-border-radius:2px;">
	...
	<td style="padding: 0px 5px;" class="social-icon-column">
      <a  href="https://www.tiktok.com/@bperfect.clinic" target="_blank" alt="Instagram" title="Instagram" style="display:inline-block; background-color:#fff; height:48px; width:48px; border-radius:2px; -webkit-border-radius:2px; -moz-border-radius:2px;">
	...
	<td style="padding: 0px 5px;" class="social-icon-column">
      <a  href="https://wa.me/+201028080800" target="_blank" alt="Instagram" title="Instagram" style="display:inline-block; background-color:#fff; height:48px; width:48px; border-radius:2px; -webkit-border-radius:2px; -moz-border-radius:2px;">
