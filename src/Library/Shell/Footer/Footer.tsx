							...
							<FooterLink>
								<Flexbox gap={8} aligncenter={"center"}>
									...
									<Link
										target={"_blank"}
										rel="noreffer"
										href={"https://facebook.com/BPerfectClinic"}
									>
							...
							<FooterLink>
								<LinkContainer>
									...
									<LinksStyles
										target="_blank"
										rel="noreferr"
										href={"https://maps.app.goo.gl/UFJv3NxisJLSKdrq9"}
									>
							...
							<FooterLink>
								<LinkContainer>
									...
									<LinksStyles
										target="_blank"
										rel="noreferr"
										href={"https://maps.app.goo.gl/Lw5PCN1HuUX8v1yS8"}
									>
